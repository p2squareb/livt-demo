...
const submit = () => {
    form.post(route('admin.board.create'), {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
            closeModal(true);
        ...
        <div class="px-6 py-3 space-y-3">
            ...
            <div class="grid grid-cols-6 gap-3">
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <TextInput type="text" id="table_id" v-model="form.table_id" class="block w-full py-[6px]" required placeholder="게시판 ID는 2~8자 영문자만 입력 가능합니다."/>
