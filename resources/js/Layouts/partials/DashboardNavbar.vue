        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <Link href="/admin" class="flex ml-2 md:mr-24"><ApplicationLogo /></Link>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <!-- Theme toggle -->
                    <button type="button" @click="toggleTheme" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-md p-2">
                    ...
                    <Dropdown :align="'right'" :width="'40'" class="mt-1">
                        <template #trigger>
                            <button type="button" data-dropdown-toggle="notification-dropdown" class="relative inline-flex items-center p-2 text-gray-500 rounded-md hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
                                ...
                                <div v-show="Number($page.props.notifications_count) > 0" class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-1 -end-1 dark:border-gray-900">
                                    {{ $page.props.notifications_count }}
                                </div>
                            </button>
                        </template>
                        <template #content>
                            <DropdownLink :href="route('admin.board.inquiry.list', { is_answer: 'off' })">
                                <span class="dark:text-gray-100">1:1 문의 미답변</span>
                                <span class="text-sm text-gray-900 dark:text-white font-semibold ml-2">{{ $page.props.notifications_count }}건</span>
                            </DropdownLink>
                            <DropdownLink :href="route('admin.board.inquiry.list', { is_answer: 'off' })">
                                <span class="dark:text-gray-100">신고 내역(미개발)</span>
                            </DropdownLink>
                        </template>
                    </Dropdown>
